...
C:\Users\Administrator\Desktop\companyManagement\qhlims>git branch -r
  origin/HEAD -> origin/master
  origin/master
  origin/migrate
  origin/qhlims_prod
  
  上面的信息显示远程git仓库有三个分支，分别是master migrate qhlims_prod，HEAD指针指向的是master
```
